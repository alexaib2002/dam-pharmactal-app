...
public class MedDataPanel extends DefaultComponent {

	private static final long serialVersionUID = 1L;

	public MedDataPanel() { // FIXME placeholder for editing
		initComponents();
	}

	@Override
	public void initComponents() {
		setBorder(new TitledBorder(new LineBorder(new Color(184, 207, 229)), "Medicine", TitledBorder.LEADING,
		...
		unitCmbx.setModel(new DefaultComboBoxModel<String>(new String[] { "g", "mg", "l", "ml" }));
